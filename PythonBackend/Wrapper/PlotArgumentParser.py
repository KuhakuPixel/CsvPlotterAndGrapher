...
class PlotRequestParser:
    ...
    def __init__(self):
        ...
        # color of plot
        self.argumentParser.add_argument('plotNameColor', type=list, default=ColorCollection.black, required=False,
                                         help="The color of the plot name")
        self.argumentParser.add_argument('xAxisLabelColor', type=list, default=ColorCollection.black, required=False,
                                         help="The label color of the x axes")
        self.argumentParser.add_argument('yAxisLabelColor', type=list, default=ColorCollection.black, required=False,
                                         help="The label color of the y axes")

        self.argumentParser.add_argument('bottomSpineColor', type=list, default=ColorCollection.black, required=False,
                                         help="The color of the plot 's bottom spine")
        self.argumentParser.add_argument('topSpineColor', type=list, default=ColorCollection.black, required=False,
                                         help="The color of the plot 's top spine")
        self.argumentParser.add_argument('leftSpineColor', type=list, default=ColorCollection.black, required=False,
                                         help="The color of the plot 's left  spine")
        self.argumentParser.add_argument('rightSpineColor', type=list, default=ColorCollection.black, required=False,
...
class HistogramPlotRequestParser(PlotRequestParser):
    def __init__(self):
        ...
        self.argumentParser.add_argument('barColor', type=list, default=ColorCollection.blue, required=False,
...
class ScatterPlotRequestParser(PlotRequestParser):
    def __init__(self):
        ...
        self.argumentParser.add_argument('dotColor', type=list, default=ColorCollection.blue, required=False,
